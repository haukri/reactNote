...
class RichEditor extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.contentState !== this.state.contentState) {
      this.setState({ editorState: nextProps.contentState });
    }
  }
  ...
  _insertImage(file) {
    Client.uploadImage(file)
        .then((response) => {
          const entityKey = Entity.create('atomic', 'IMMUTABLE', {src: JSON.parse(response).id});
